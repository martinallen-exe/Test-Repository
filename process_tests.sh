...
#
#********START USER_INPUTS*********
TESTSIGMA_API_KEY=eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiI2NmRmNmJkOS03MWQwLTRmYWEtYWIzYi1hODlmNTY2NDRiNTMiLCJkb21haW4iOiJleGUtc3F1YXJlZC5jby51ayIsInRlbmFudElkIjo1MzE4Nn0.etusqKxDLcn0ETEAz4s_0nfZDmUBHSeD2c5-YpWXekHvCSAByWQjHVWf6qRA9UElDaDCcVmLn6gDnpuljAWhcQ
TESTSIGMA_TEST_PLAN_ID=44
MAX_WAIT_TIME_FOR_SCRIPT_TO_EXIT=1
JUNIT_REPORT_FILE_PATH=./junit-report-$(date +"%Y%m%d%H%M").xml
RUNTIME_DATA_INPUT="url=https://vtiger74.exe-squared.co.uk/index.php"
